...
class SsmlGenerator
{
    ...
    {
        if(!in_array($strength, self::BREAK_STRENGTHS)) {
    ...
    {
        if(!in_array($effect, self::AMAZON_EFFECTS)) {
    ...
    {
        if(!in_array($level, self::EMPHASIS_LEVELS)) {
    ...
    {
        if(!in_array($alphabet, self::PHONEME_ALPHABETS)) {
    ...
    {
        if(!in_array($interpretAs, self::SAY_AS_INTERPRET_AS)) {
